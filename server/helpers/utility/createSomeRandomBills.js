...
async function generateRandomBills(billCount = 5, productsCount = 3,maxQuantity=10) {
    ...
    for (var billIteration = 0; billIteration < billCount; billIteration++) {
        ...
        for (var productIteration = 0; productIteration < getRandomCount(productsCount); productIteration++){
